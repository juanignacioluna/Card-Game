...
export class JugarComponent implements OnInit {
  ...
  finalizarTurno(event){
      ...
      fetch('http://localhost/pruebasLARAVEL/cardGame01/back/public/api/cardgames/'+ this.playerName, {
        method: 'PUT', 
        headers: {
  ...
  ngOnInit() {
    ...
    this.activatedRoute.params.subscribe( params => {
      ...
      fetch('http://localhost/pruebasLARAVEL/cardGame01/back/public/api/cardgames', {
        method: 'POST', 
        headers: {
          'Content-Type': 'application/json',
        },
